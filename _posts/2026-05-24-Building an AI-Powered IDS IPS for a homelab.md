...
* SELKS package by Stamus Networks![Attachment.tiff](file:///Attachment.tiff)
* mikrocata2selks integration project![Attachment.tiff](file:///Attachment.tiff) for easier SELKS deployment
* **Proxmox VE** as the hypervisor
* Ollama![Attachment.tiff](file:///Attachment.tiff) with GPU acceleration for AI analysis
